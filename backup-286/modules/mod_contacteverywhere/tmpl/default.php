...
<?php if (!empty($contact_info)): ?>
        <div class="row">
                ...
                <form action="<?php echo $url; ?>" method="POST">
                        ...
                        <div class="form-group">
                                <input type="text" class="form-control" name="rp_subject" placeholder="<?php echo $mySubjectLabel; ?>" value="<?php echo $mySubjectValue; ?>"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                <button class="contact-button btn btn-default btn-block" type="submit"><span class="hidden fa fa-spinner fa-pulse fa-fw margin-bottom"></span><?php echo $buttonText; ?></button>
                        </div>
                </form>
                <?php if (!empty($contact_info)): ?>
                </div>
