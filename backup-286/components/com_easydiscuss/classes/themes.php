...
if (!class_exists('DiscussThemes'))
{
        ...
        class DiscussThemes
        {
                ...
                function getUnansweredCount($tagId = '0')
                {
                        ...
                        $query->leftJoin('#__discuss_posts AS b ON a.id = b.parent_id AND p.published = 1');
                        if (!empty($tagId))
                        {
                ...
                function getFeaturedCount($tagId = '0')
                {
                        ...
                        if (!empty($tagId))
                        {
                                $query->innerJoin('#__discuss_posts_tags AS b ON a.id = b.post_id AND b.tag_id = ' . $db->quote($tagId));
                        }
