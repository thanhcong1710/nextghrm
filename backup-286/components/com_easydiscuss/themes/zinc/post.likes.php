...
<?php if( ( $system->config->get( 'main_likes_discussions' ) && !$post->parent_id ) || ( $system->config->get( 'main_likes_replies' ) && $post->parent_id ) ){ ?>
	...
	?>
<div class="discuss-post-likes inline-block discussLikes" data-postid="<?php echo $post->id;?>" data-registered-user="<?php echo $system->my->id ? "true" : "false"; ?>">
	<a href="javascript:void(0);" class="butt butt-default btn-likes<?php echo $isLiked ? ' butt-primary btnUnlike' : ' btnLike';?>" href="javascript:void(0);" rel="ed-tooltip" data-placement="top" data-original-title="<?php echo JText::_( $message , true );?>">
		<span class="likeStatus"><?php echo JText::_($status);?></span>
	</a>
