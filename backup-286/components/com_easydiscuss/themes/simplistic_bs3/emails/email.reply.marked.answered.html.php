...
?>
<?php echo JText::sprintf( 'COM_EASYDISCUSS_EMAILTEMPLATE_YOUR_REPLY_MARKED_ANSWERED' , $postTitle ); ?><?php echo JText::_( 'COM_EASYDISCUSS_EMAILTEMPLATE_MARKED_RESOLVED' ); ?>
<br />
