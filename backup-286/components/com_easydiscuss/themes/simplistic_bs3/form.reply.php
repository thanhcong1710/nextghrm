				...
				<div class="discuss-form">
					...
					<div class="form-actions">
						<div class="pull-right">
							<input type="button" name="submit-reply" class="btn btn-primary btn-medium" value="<?php echo JText::_('COM_EASYDISCUSS_BUTTON_SUBMIT_RESPONSE'); ?>" onclick="discuss.reply.submit('<?php echo $composer->id; ?>');return false;" />
						</div>
