...
class EasyDiscussModelUsers extends EasyDiscussModel
{
        ...
        function __construct()
        {
                ...
                $limit = $app->getUserStateFromRequest('com_easydiscuss.users.limit', 'limit', DiscussHelper::getListLimit(), 'int');
        ...
        function _buildQueryOrderBy()
        {
                ...
                $filter_order = $app->getUserStateFromRequest('com_easydiscuss.users.filter_order', 'sort', 'name ASC', 'cmd');
                $filter_order_Dir = $app->getUserStateFromRequest('com_easydiscuss.users.filter_order_Dir', 'dir', '', 'word');
