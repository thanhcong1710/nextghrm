...
class NextgCyberModelInstances extends NextgCyberModelBaseList {

    protected $odoo_model = 'nc.instance';
    protected $context = 'com_nextgcyber.nc.instance';
    ...
    protected function getListQuery() {
        ...
        $query->select('id, name, publish_down, create_date, type, used_user, used_bandwidth, used_storage, used_backup,'
                . 'max_user, max_bandwidth, max_storage, max_backup, customer_domain_ids, allowed_module_ids, vserver_id, sale_order_ids, based_domain_id');
    ...
    public function getItems() {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as &$item) {
                $item = $instanceModel->getInfo($item);
            }
            unset($item);
        }
        $this->_items = $items;
