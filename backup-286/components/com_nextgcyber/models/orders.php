...
class NextgCyberModelOrders extends NextgCyberModelBaseList {

    protected $odoo_model = 'sale.order';
    protected $context = 'com_nextgcyber.sale.order';
    ...
    protected function getListQuery() {
        ...
        $query->select('id, name, partner_id, state, pricelist_id, create_date, date_order, amount_untaxed, amount_tax, amount_total, nc_payment_period_id');
    ...
    public function getItems() {
        ...
        foreach ($items as &$item) {
            $item->orderlines = $orderModel->getOrderLines($item->id);
        }
        unset($item);
        $this->_items = $items;
        return $this->_items;
