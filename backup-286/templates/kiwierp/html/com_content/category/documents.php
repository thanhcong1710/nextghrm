...
?>
<div class="kiwierp-template documents<?php echo $this->pageclass_sfx; ?>">
        ...
        <?php if (!empty($this->lead_items)) : ?>
                <div class="items-leading clearfix">
                        <?php foreach ($this->lead_items as &$item) : ?>
                                <div class="document-item leading-<?php echo $leadingcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?>"
                ...
                <?php foreach ($this->intro_items as $key => &$item) : ?>
                        ...
                        <?php if ($rowcount == 1) : ?>
                                ...
                                <div class="col-md-<?php echo round((12 / $this->columns)); ?>">
                                        <div class="document-item column-<?php echo $rowcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?>"
                                             itemscope itemtype="http://schema.org/TechArticle">
                                                     <?php
                                                     $this->item = & $item;
                                                     echo $this->loadTemplate('item');
