...
<nav class="navbar navbar-default">
        <div class="container">
                <div class="navbar-header">
                        ...
                        <a class="navbar-brand col-xs-4 col-sm-4" title="NextG-WEB" href="<?php echo $root_page; ?>"><img src="<?php echo $logo; ?>" class="erp-logo-small logo" alt="NextG-WEB"/></a>
                        <p class="site-name">NextG-WEB</p>
                </div>
