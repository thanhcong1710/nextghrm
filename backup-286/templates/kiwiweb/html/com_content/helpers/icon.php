...
abstract class JHtmlIcon
{
        ...
        public static function create($category, $params, $attribs = array(), $legacy = false)
        {
                ...
                if ($params->get('show_icons'))
                {
                        ...
                        {
                                $text = '<span class="fa fa-plus-square"></span>&#160;' . JText::_('JNEW') . '&#160;';
                        }
                } else
                {
                        $text = JText::_('JNEW') . '&#160;';
        ...
        public static function email($article, $params, $attribs = array(), $legacy = false)
        {
                ...
                if ($params->get('show_icons'))
                {
                        ...
                        {
                                $text = '<span class="fa fa-envelope-o fa-fw"></span> ' . JText::_('JGLOBAL_EMAIL');
                        }
                } else
                {
        ...
        public static function edit($article, $params, $attribs = array(), $legacy = false)
        {
                ...
                if ($legacy)
                {
                        ...
                        if (strtotime($article->publish_up) > strtotime(JFactory::getDate()) || ((strtotime($article->publish_down) < strtotime(JFactory::getDate())) && $article->publish_down != '0000-00-00 00:00:00'))
                        {
                ...
                } else
                {
                        ...
                        $text = '<span class="hasTooltip fa fa-' . $icon . ' fa-fw tip" title="' . JHtml::tooltipText(JText::_('COM_CONTENT_EDIT_ITEM'), $overlib, 0) . '"></span>&#160;' . JText::_('JGLOBAL_EDIT') . '&#160;';
                }
        ...
        public static function print_popup($article, $params, $attribs = array(), $legacy = false)
        {
                ...
                if ($params->get('show_icons'))
                {
                        ...
                        {
                                $text = '<span class="fa fa-print fa-fw"></span>&#160;' . JText::_('JGLOBAL_PRINT') . '&#160;';
                        }
                } else
                {
