...
$document->addStyleSheet(JUri::root(true) . '/templates/kiwiweb/css/content.css');
...
$menu = $app->getMenu();
$activedMenu = $menu->getActive();
$menuLayout = (!empty($activedMenu->query['layout'])) ? $activedMenu->query['layout'] : "";
$templateparams = $app->getTemplate(true)->params;
$blog_style = $templateparams->get('blog_style');
switch ($menuLayout) {
        case 'kiwiweb:documents':
                include('default_documents.php');
                return;

        case 'kiwiweb:eblog':
                include('default_eblog.php');
                return;

        case 'kiwiweb:odoomodule':
                include('default_odoomodule.php');
                return;

        case 'kiwiweb:videos':
                include('default_videos.php');
                return;
        case 'kiwiweb:testimonial':
                include('default_testimonial.php');
                return;
}
// Custom code
