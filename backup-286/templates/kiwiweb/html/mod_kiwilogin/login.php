...
if ($params->get('displayType') == 'modal') {
        if ($params->get('modalButtonStyle') == 'button') {
                echo '<div class="kiwi-login-module"><a class="btn btn-primary" href="' . $login_link . '">';
                echo $logintext;
                echo '</a>';
                ...
                . '<li><a href="' . $login_link . '" class="btn btn-default">LOGIN</a></li>'
                . '<li><a href="' . $registerLink . '" class="btn btn-info btn-white">SIGN UP FREE</a></li>'
                . '</ul>';
        }
