...
?>
<div class="contact-page contact<?php echo $this->pageclass_sfx ?>">
        ...
        <?php if ($this->params->get('show_contact_list') && count($this->contacts) > 1) : ?>
                <form action="#" method="get" name="selectForm" id="selectForm">
                        ...
                        <?php echo JHtml::_('select.genericlist', $this->contacts, 'id', 'class="form-control" onchange="document.location.href = this.value"', 'link', 'name', $this->contact->link); ?>
                </form>
        <?php endif; ?>
