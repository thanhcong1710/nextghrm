                ...
                <div class="widget accordion-group">
                        ...
                        <div id="option01" class="accordion-body collapse in">
                                <div class="wbody">
                                        ...
                                        <div class="si-form-row">
                                                <div class="span5 form-row-label">
                                                        <label><?php echo JText::_('COM_EASYDISCUSS_LANGUAGE_TITLE'); ?></label>
                                                </div>
                                                <div class="span7"
                                                     rel="ed-popover"
                                                     data-placement="left"
                                                     data-original-title="<?php echo JText::_('COM_EASYDISCUSS_LANGUAGE_TITLE'); ?>"
                                                     data-content="<?php echo JText::_('COM_EASYDISCUSS_LANGUAGE_DESC'); ?>"
                                                     >
                                                             <?php echo DiscussHelper::getLanguageField('language', $this->cat->language); ?>
                                                </div>
                                        </div>
