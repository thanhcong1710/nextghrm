...
class NextgCyberModelOrders extends NextgCyberModelBaseList {
    ...
    public function clearState() {
        ...
        $this->setState('filter.nc_instance_id', null);
    ...
    protected function getListQuery() {
        ...
        $query->select('id, name, state, nc_type');
        ...
        $instance_id = $this->getState('filter.nc_instance_id');
        if ($instance_id) {
            $query->where(array('nc_instance_id.id', '=', (int) $instance_id));
        }
