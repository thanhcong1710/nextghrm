...
<script type="text/javascript">
    ...
    {
        if (task == 'partner.cancel' || document.formvalidator.isValid(document.getElementById('item-form')))
        {
...
<form action="<?php echo JRoute::_('index.php?option=com_nextgcyber&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <div class="control-group">
            <div class="control-label">
                <?php echo $this->form->getLabel('customer'); ?>
            </div>
            <div class="controls">
        ...
        <div class="control-group">
            <div class="control-label">
                <?php echo $this->form->getLabel('is_company'); ?>
            </div>
            <div class="controls">
                <?php echo $this->form->getInput('is_company'); ?>
            </div>
        </div>
    ...
    <div>
        <input type="hidden" name="task" value="partner.edit" />
