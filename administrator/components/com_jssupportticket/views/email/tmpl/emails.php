...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
        <div id="js-tk-heading">
            <h4><img id="js-admin-responsive-menu-link" src="components/com_jssupportticket/include/images/c_p/left-icons/menu.png" /><?php echo JText::_('Email'); ?></h4>
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                ...
                <div class="tk-search-button">
                    ...
                    <button onclick="this.form.getElementById('filter_email').value = ''; this.form.getElementById('filter_autoresponcetype').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
                    ...
                    <table id="js-table">
                        ...
                        <tbody>
                            ...
                            foreach ($this->emails AS $row) {
                                ...
                                $deletelink = 'index.php?option='.$this->option.'&c=email&task=deleteemail&cid[]='.$row->id; ?>
                                <tr>
