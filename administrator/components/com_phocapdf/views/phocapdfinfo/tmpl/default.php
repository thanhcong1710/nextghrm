...
echo '<div class="btn-group" style="float:left;"><a class="btn btn-large btn-primary" href="http://www.phoca.cz/version/index.php?phocapdf='.  $this->t['version'] .'" target="_blank"><i class="icon-loop icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_FOR_UPDATE') .'</a></div>';


echo '<div class="btn-group" style="float:left;"><a class="btn btn-large btn-info" href="http://www.phoca.cz/phocapdf-plugins" target="_blank"><i class="icon-share icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_FOR_AVAILABLE_PLUGINS') .'</a></div>';
