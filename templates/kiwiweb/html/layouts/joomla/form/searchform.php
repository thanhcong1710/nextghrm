...
<form class="form-inline search-form">
        ...
        <div class="form-group">
                <div class="input-group">
                        ...
                        <input type="text" name="keyword" class="form-control" placeholder="<?php echo JText::_('TPL_KIWI_WEB_SEARCH_FORM_KEYWORD_PLACEHOLDER'); ?>">
                </div>
        </div>
        <button type="submit" class="btn btn-success inline-search"><?php echo JText::_('TPL_KIWI_WEB_SEARCH_FORM_SEARCH_BUTTON_LABEL'); ?></button>
</form>