...
?>
<div class="kiwiweb-template odoo-module<?php echo $this->pageclass_sfx; ?>" itemscope='itemscope' itemtype='http://schema.org/EntryPoint'>
        ...
        <?php if (empty($this->lead_items) && empty($this->link_items) && empty($this->intro_items)) : ?>
                <?php if ($this->params->get('show_no_articles', 1)) : ?>
                        <p><?php echo JText::_('TPL_KIWI_WEB_NO_ARTICLES'); ?></p>
                <?php endif; ?>
        <?php endif; ?>
