                ...
                <div class="login<?php echo $this->pageclass_sfx ?>">
                        ...
                        <div class="panel panel-default">
                                <div class="panel-heading">
                                        <h3 class="panel-title"><?php echo JText::_('TPL_KIWI_WEB_LOGIN_PAGE_LOGIN_HEADER'); ?></h3>
                                </div>
                                <div class="panel-body">
                                        <form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-horizontal form-validate">
                                                ...
                                                <fieldset>
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                        ...
                                                                                        if ($usersConfig->get('allowUserRegistration')) :
                                                                                                ...
                                                                                                <a class="btn btn-success2 btn-block" href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>">
                                                                                                        <?php echo JText::_('TPL_KIWI_WEB_REGISTER_PAGE_HEADER'); ?>
                                                                                                </a>
                                                        ...
                                                        $return = (!empty($app->input->getString('return'))) ? $app->input->getString('return') : base64_encode(JRoute::_(NextgCyberHelperRoute::getDashboardRoute(), false));
