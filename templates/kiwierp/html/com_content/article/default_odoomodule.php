...
<div class="kiwierp-template item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/SoftwareApplication">
        ...
        echo '<meta itemprop="applicationCategory" content="Odoo, OpenERP, ERPOnline" />';
        echo '<meta itemprop="device" content="mobile, tablet, pc" />';
        echo '<meta itemprop="provider" content="ERPOnline" />';
        echo '<meta itemprop="applicationSuite" content="ERPOnline" />';
        echo '<meta itemprop="operatingSystem" content="Linux" />'
        ?>
        ...
        <?php if ($info == 0 && $params->get('show_tags', 1) && !empty($this->item->tags->itemTags)) : ?>
                <?php $this->item->tagLayout = new JLayoutFile('joomla.content.odoo_tags'); ?>
