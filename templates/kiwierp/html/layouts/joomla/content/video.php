                                ...
                                <div class="video-detailt">
                                        ...
                                        <div class="video-info">
                                                <div class="view-counter">
                                                        <p><i class="fa fa-eye"></i>&nbsp;<?php echo JText::sprintf('TPL_KIWI_ERP_VIDEO_VIEW', $displayData->hits); ?>&nbsp;&nbsp;&nbsp;<i class="fa fa-calendar"></i>&nbsp;<?php echo JHTML::_('date', $displayData->created, 'DATE_FORMAT_LC3'); ?></p>
                                                </div>
                                        </div>
                                </div>
                        <?php endif; ?>
