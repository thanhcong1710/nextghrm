	...
	<div class="tab-box">
		<div class="tabbable">
			<ul class="nav nav-tabs editProfileTabs">
				<?php if( $system->config->get( 'layout_avatar' ) && $system->config->get( 'layout_avatarIntegration') == 'default' || $system->config->get( 'layout_avatarIntegration') == 'gravatar' || $allowJFBCAvatarEdit ){ ?>
				<li id="photo">
		...
		<div class="modal-footer">
			<div class="form-submit ">
				<input type="submit" class="btn btn-medium btn-primary pull-right" name="save" value="<?php echo JText::_('COM_EASYDISCUSS_BUTTON_SAVE'); ?>" />
			</div>
		</div>
	</div>
