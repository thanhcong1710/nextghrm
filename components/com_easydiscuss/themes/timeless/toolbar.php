...
.done(function($){
	...
	$.responsive($('.discuss-toolbar'), {
		elementWidth: function() {
			return $('.discuss-toolbar').outerWidth(true) - 0;
	...
	$('.btn-navbar').click(function() {
		$('.es-nav-collapse').toggleClass("collapse in",250); //transition effect required jQueryUI
		return false;
	});
});
</script>
...
<div class="discuss-head">
	...
	<?php if( $system->config->get( 'main_rss' ) || $config->get( 'main_sitesubscription' ) ){ ?>
	<div class="row-fluid">
	<div class="discuss-subscribe pull-left mb-20">
		<div class="pull-left">
...
<div class="navbar discuss-toolbar discuss-toolbar-modern">
	<div class="navbar-inner">
		...
		<div class="ed-nav-collapse nav-collapse collapse">
			<ul class="nav">
				...
				<li class="toolbarItem<?php echo $views->index;?>">
					<a href="<?php echo DiscussRouter::_('index.php?option=com_easydiscuss&view=index'); ?>" rel="ed-tooltip" data-placement="top"
						...
						<!-- <i class="icon-ed-tb-home"></i> -->
						<span class=""><?php echo JText::_('COM_EASYDISCUSS_TOOLBAR_HOME'); ?></span>
					</a>
				</li>
				...
				<li class="toolbarItem<?php echo $views->categories;?>">
					<a href="<?php echo DiscussRouter::_('index.php?option=com_easydiscuss&view=categories'); ?>" rel="ed-tooltip" data-placement="top"
						...
						<!-- <i class="icon-ed-tb-categories"></i> -->
						<span class=""><?php echo JText::_('COM_EASYDISCUSS_TOOLBAR_CATEGORIES'); ?></span>
					</a>
				</li>
				<li class="divider-vertical"></li>
				<?php } ?>
				...
				<?php if( $config->get( 'main_master_tags' ) ){ ?>
					...
					<li class="toolbarItem<?php echo $views->tags;?>">
						<a href="<?php echo DiscussRouter::_('index.php?option=com_easydiscuss&view=tags'); ?>" rel="ed-tooltip" data-placement="top"
							...
							<!-- <i class="icon-ed-tb-tags"></i> -->
							<span class=""><?php echo JText::_('COM_EASYDISCUSS_TOOLBAR_TAGS'); ?></span>
						</a>
					</li>
					<li class="divider-vertical"></li>
					<?php } ?>
				...
				<li class="toolbarItem<?php echo $views->users;?>">
					<a href="<?php echo DiscussRouter::_('index.php?option=com_easydiscuss&view=users'); ?>" rel="ed-tooltip" data-placement="top"
						...
						<!-- <i class="icon-ed-tb-members"></i> -->
						<span class=""><?php echo JText::_('COM_EASYDISCUSS_TOOLBAR_USERS'); ?></span>
					</a>
				</li>
				<li class="divider-vertical"></li>
				<?php } ?>
				...
				<li class="toolbarItem<?php echo $views->badges;?>">
					<a href="<?php echo DiscussRouter::_('index.php?option=com_easydiscuss&view=badges'); ?>" rel="ed-tooltip" data-placement="top"
						...
						<!-- <i class="icon-ed-tb-badges"></i> -->
						<span class=""><?php echo JText::_('COM_EASYDISCUSS_TOOLBAR_BADGES'); ?></span>
					</a>
				</li>
				<li class="divider-vertical"></li>
				<?php } ?>
			...
			<ul class="nav nav-alt pull-right">
				...
				<li class="dropdown_">
					<a class="dropdown-toggle_ profileLink">
						...
						<span class=""><i class="icon-ed-tb-user"></i><?php echo $system->profile->getName();?></span> <b class="caret"></b>
					</a>
					<ul class="dropdown-menu dropdown-menu-large profileDropDown">
						<li>
				...
				<li class="divider-vertical"></li>
					<li class="dropdown_">
						<a class="dropdown-toggle_ loginLink" href="javascript:void(0);">
							...
							<span class=""><?php echo JText::_('COM_EASYDISCUSS_TOOLBAR_LOGIN'); ?></span> <b class="caret"></b>
						</a>
...
<div class="row-fluid">
	...
	<div class="span4">
		...
		<div class="pull-right">
			<a class="btn btn-info btn-large btn-ask pull-left" href="<?php echo DiscussRouter::getAskRoute( $categoryId );?>"><?php echo JText::_( 'COM_EASYDISCUSS_START_NEW_DISCUSSION' );?></a>
		</div>
		<?php } ?><!-- btn ask -->
	</div>
</div>
...
<div class="discuss-searchbar">
	<div class="discuss-xtable">
		<div class="discuss-xtablecell discuss-searchbar--center">
