...
$return = $this->options->get('return');
?>
<div>
    <form class="form-vertical" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="nc_input_payment_period_id">
                <?php
        ...
        <div class="form-group">
            <div>
                <button type="button" class="btn btn-primary nc-button" data-id="<?php echo $displayData->id; ?>" data-return="<?php echo $return; ?>" data-action="upgrade" data-token="<?php echo $displayData->token; ?>">
