// Camera slideshow v1.3.11 - a jQuery slideshow with many effects, transitions, easy to customize, using canvas and mobile ready, based on jQuery 1.4+
...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		source				: 'flickr',	// default, flickr: to get the photos from the html code, or directly from flickr 
...
//	if(opts.loader=='pie' && $.browser.msie && $.browser.version < 9){
	...
	if (opts.source == 'flickr') {
		url ='https://api.flickr.com/services/rest/?format=json&api_key=067e565523445e2b7c7dfcceb18a861f&method=flickr.photosets.getPhotos&photoset_id=72157657248195018&extras=original_format,url_sq,url_t,url_s,url_m,url_o&nojsoncallback=1';
		console.log(url);
