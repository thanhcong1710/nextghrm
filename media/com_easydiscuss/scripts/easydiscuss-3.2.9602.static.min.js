...
}(jQuery)};exports(),module.resolveWith(exports)};FD31.module("markitup",moduleFactory)}(),function(){var a=function(a){var b=this,c=function(){function f(){var b=a(this).data("textareaClone");b.find("div").text(this.value.replace(/\r\n/g,"\n")+" "),a(this).trigger("resize.expanding")}a.expandingTextarea=a.extend({autoInitialize:!0,initialSelector:"textarea.expanding",opts:{resize:function(){}}},a.expandingTextarea||{});var b=["lineHeight","textDecoration","letterSpacing","fontSize","fontFamily","fontStyle","fontWeight","textTransform","textAlign","direction","wordSpacing","fontSizeAdjust","wordWrap","word-break","borderLeftWidth","borderRightWidth","borderTopWidth","borderBottomWidth","paddingLeft","paddingRight","paddingTop","paddingBottom","marginLeft","marginRight","marginTop","marginBottom","boxSizing","webkitBoxSizing","mozBoxSizing","msBoxSizing"],c={position:"absolute",height:"100%",resize:"none"},d={visibility:"hidden",border:"0 solid",whiteSpace:"pre-wrap"},e={position:"relative"};
...
j.css(b)!==c&&j.css(b,c)}),g.bind("input.expanding propertychange.expanding keyup.expanding",f),f.apply(this),h.resize&&g.bind("resize.expanding",h.resize)}),this)},a(function(){a.expandingTextarea.autoInitialize&&a(a.expandingTextarea.initialSelector).expandingTextarea()})};c(),b.resolveWith(c)};FD31.module("expanding",a)}(),function(){var a=function(a){var b=this,c=a,d=function(){!function(a,b,c){function j(a){var b={},d=/^jQuery\d+$/;return c.each(a.attributes,function(a,c){c.specified&&!d.test(c.name)&&(b[c.name]=c.value)
...
for(var d=c.length,e=null,f=0;d>f;f++)e=c[f],$("#poll-count-"+e).removeAttr("disabled","disabled"),$("#poll-count-"+e).removeProp("disabled","disabled");$("#poll_notice_"+b).html(""),$("#poll_notice_"+b).parent().removeClass("alert")})}},tabs:{show:function(a,b){$(".form-tab-item").hide(),$(a).parent().siblings().removeClass("active"),$(a).parent().addClass("active"),$(".tab-"+b).show()}},toolbar:{login:function(){$("#dc_toolbar .to_login div.toolbar-note").toggle()}}};window.effect=effect={highlight:function(a){setTimeout(function(){$(a).animate({backgroundColor:"#ffff66"},300).animate({backgroundColor:"transparent"},1500)
},500)}},disjax=window.disjax=disjax={http:!1,format:"text",callback:function(){},error:!1,btnArray:new Array,getHTTPObject:function(){var a=!1;if("undefined"!=typeof ActiveXObject)try{a=new ActiveXObject("Msxml2.XMLHTTP")}catch(b){try{a=new ActiveXObject("Microsoft.XMLHTTP")}catch(c){a=!1}}else if(XMLHttpRequest)try{a=new XMLHttpRequest}catch(b){a=!1}this.http=a},load:function(view,method){var callback={};"object"==typeof view&&(callback=view.callback,view=view.view),url=discuss_site,url+="&tmpl=component",url+="&no_html=1",url+="&format=ajax",url+="&uid="+(new Date).getTime();
var parameters="";if(parameters="&view="+view+"&layout="+method,arguments.length>2)for(var i=2;i<arguments.length;i++){var myArgument=arguments[i];if($.isArray(myArgument))for(var j=0;j<myArgument.length;j++){var argument=myArgument[j];if("string"==typeof argument){var expr=/^\w+\(*\)$/,match=expr.exec(argument),arg=argument;match||(arg=escape(arg)),parameters+="&value"+(i-2)+"[]="+encodeURIComponent(arg)}}else{var argument=myArgument;if("string"==typeof argument){var expr=/^\w+\(*\)$/,match=expr.exec(argument),arg=argument;
match||(arg=escape(arg)),parameters+="&value"+(i-2)+"="+encodeURIComponent(arg)}}}var token=$(".easydiscuss-token").val();if(parameters+="&"+token+"=1",this.getHTTPObject(),this.http&&view&&method){var ths=this;this.http.open("POST",url,!0),this.http.setRequestHeader("Content-type","application/x-www-form-urlencoded"),this.http.setRequestHeader("Content-length",parameters.length),this.http.setRequestHeader("Connection","close"),this.http.onreadystatechange=function(){if(ths){var http=ths.http;if(4==http.readyState)if(200==http.status){var result="";
http.responseText&&(result=http.responseText),result=result.replace(/[\n\r]/g,""),result=eval(result),ths.process(result,callback)}else ths.error&&ths.error(http.status)}},this.http.send(parameters)}},getFormVal:function(a){var b=[],c=null;return $(":input",$(a)).each(function(){c=this.value.replace(/"/g,"&quot;"),c=encodeURIComponent(c),$(this).is(":checkbox")||$(this).is(":radio")?$(this).prop("checked")&&b.push(this.name+"="+escape(c)):b.push(this.name+"="+escape(c))}),b},process:function(result,callback){if("function"==typeof callback)return callback.apply(this,result);
for(var i=0;i<result.length;i++){var action=result[i][0];switch(action){case"script":var data=result[i][1];eval(data);break;case"after":var id=result[i][1],value=result[i][2];$("#"+id).after(value);break;case"append":var id=result[i][1],value=result[i][2];$("#"+id).append(value);break;case"assign":var id=result[i][1],value=result[i][2];$("#"+id).html(value);break;case"value":var id=result[i][1],value=result[i][2];$("#"+id).val(value);break;case"prepend":var id=result[i][1],value=result[i][2];$("#"+id).prepend(value);
break;case"destroy":var id=result[i][1];$("#"+id).remove();break;case"dialog":disjax.dialog(result[i][1]);break;case"alert":disjax.alert(result[i][1],result[i][2],result[i][3]);break;case"create":}}delete result},loadingDialog:function(){disjax.dialog({title:$.language("COM_EASYDISCUSS_LOADING"),loading:!0})},dialog:function(a){disjax._showPopup(a)},closedlg:function(){var a=$("#discuss-dialog"),b=$("#discuss-overlay");b.hide(),a.unbind(".dialog").hide(),$(document).off("click.ed.closedlg"),$(document).unbind("keyup",disjax._attachPopupShortcuts)
},_showPopup:function(a){var b={width:"500",height:"auto",type:"dialog",loading:!1},a=$.extend({},b,a),c=$("#discuss-dialog");c.length<1&&(dialogTemplate='<div id="discuss-dialog" class="modal"><div class="modal-header"><a href="javascript:void(0);" aria-hidden="true" onclick="disjax.closedlg();" class="close">x</a><h3 class="modal-title"></h3></div><div class="modal-body"></div><div class="modal-footer"></div>',c=$(dialogTemplate).appendTo("body")),c.fadeOut(0),a.loading?c.addClass("modal-loading"):c.removeClass("modal-loading");
var d=c.children(".modal-body");"string"==typeof a.title?c.find("h3.modal-title").html(a.title):c.find("h3.modal-title").html("&nbsp;");var e=c.find(".modal-footer");$.isArray(a.buttons)?(e.html("").show(),$.each(a.buttons,function(a,b){var c=b.className,d=b.title,f=b.action,g=b.form,h=$(document.createElement("a")).attr("href","javascript: void(0);").addClass("btn "+c).html(d);f&&h.attr("onclick",f),g&&h.bind("click",function(){$(g).submit()}),e.append(h)})):e.hide(),d.html(a.content),c.css({width:"auto"==a.width?"auto":parseInt(a.width),height:"auto"==a.height?"auto":parseInt(a.height),margin:0,zIndex:99999}).show(0,function(){var b,a=function(){c.css({top:($(window).height()-c.height())/2,left:($(window).width()-c.width())/2})
};$(window).bind("resize.dialog scroll.dialog",function(){clearTimeout(b),b=setTimeout(a,50)}),a()}),$(document).on("click.ed.closedlg","#edialog-cancel, #edialog-submit",function(){disjax.closedlg()}),$(document).bind("keyup",disjax._attachPopupShortcuts)},_attachPopupShortcuts:function(a){27==a.keyCode&&disjax.closedlg()}},$(function(){$("[rel=ed-tooltip]").tooltip({animation:!1,container:"body",template:'<div class="tooltip tooltip-ed"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>'})
}),$(document).on("mouseover","[rel=ed-popover]",function(){$(this).popover({container:"body",delay:{show:100,hide:100},animation:!1,trigger:"hover"})}),module.resolve()}),EasyDiscuss.module("favourites",function(){var b=this;EasyDiscuss.require().language("COM_EASYDISCUSS_FAVOURITE_BUTTON_UNFAVOURITE","COM_EASYDISCUSS_FAVOURITE_BUTTON_FAVOURITE").done(function(a){EasyDiscuss.Controller("Post.Favourites",{defaultOptions:{postId:null,"{favButton}":".btnFav","{removeButton}":".btnRemove","{favLoader}":".favLoader","{favCount}":".favCount"}},function(b){return{init:function(){b.options.postId=b.element.data("postid")
},"{favButton} click":function(c){EasyDiscuss.ajax("site.views.favourites.favourite",{postid:b.options.postId},{beforeSend:function(){a(".favLoader").show(),a(".favCount").empty()}}).done(function(b,d){b?(c.addClass("isfav"),a(c).html(a.language("COM_EASYDISCUSS_FAVOURITE_BUTTON_UNFAVOURITE")),a(".favCount").html(d)):(c.removeClass("isfav btn-primary"),a(c).html(a.language("COM_EASYDISCUSS_FAVOURITE_BUTTON_FAVOURITE")),a(".favCount").html(d))}).fail(function(){}).always(function(){a(".favLoader").hide()})},"{removeButton} click":function(c){EasyDiscuss.ajax("site.views.favourites.remove",{postid:b.options.postId}).done(function(){c.removeClass("isfav"),a(".discussItem"+b.options.postId).remove()
}).fail(function(){})}}}),b.resolve()})}),EasyDiscuss.module("filterbar",function(a){var b=this;EasyDiscuss.Controller("DiscussFilterBar",{defaultOptions:{catId:null,"{allpostsButton}":".allpostsBtn","{featuredButton}":".featuredBtn","{newButton}":".newBtn","{unansweredButton}":".unansweredBtn"}},function(b){return{init:function(){},"{allpostsButton} click":function(){b.filter("allposts")},"{featuredButton} click":function(){b.filter("featured")},"{newButton} click":function(){b.filter("new")},"{unansweredButton} click":function(){b.filter("unanswered")
},filter:function(c){var d=0==b.options.catId?null:b.options.catId;EasyDiscuss.ajax("site.views.index.filter",{args:[c,d]},{beforeSend:function(){discuss.spinner.show("index-loading"),a("#dc_list").hide(),a("#dc_pagination").hide(),a("#filter-links").children().removeClass("active")},success:function(b,c,d,e,f,g){b&&a("#dc_featured_list").show(),a("#dc_list").html(c),a("#sort-wrapper").html(),a("#pagination-filter").val(e),a("#pagination-start").val(f),a("#dc_pagination").html(g)},complete:function(){discuss.spinner.hide("index-loading"),a("#dc_list").show(),a("#dc_pagination").show(),a("#filter-links").find("."+c).addClass("active")
}})}}}),b.resolve()}),EasyDiscuss.module("likes",function(a){var b=this;EasyDiscuss.require().language("COM_EASYDISCUSS_UNLIKE_THIS_POST","COM_EASYDISCUSS_LIKE_THIS_POST","COM_EASYDISCUSS_UNLIKE","COM_EASYDISCUSS_LIKES").done(function(a){EasyDiscuss.Controller("Likes",{defaultOptions:{postId:null,registeredUser:null,"{likeButton}":".btnLike","{unlikeButton}":".btnUnlike","{likeText}":".likeText","{likeCount}":".likeCount","{likeStatus}":".likeStatus"}},function(b){return{init:function(){b.options.postId=b.element.data("postid"),b.element.data("like",!0)
},getLikesData:function(){EasyDiscuss.ajax("site.views.likes.getData",{id:b.options.postId}).done(function(a){b.likeText().html(a)})},likeItem:function(){return b.options.registeredUser?(EasyDiscuss.ajax("site.views.likes.like",{postid:b.options.postId}).done(function(a,c){b.likeText().html(a),b.likeCount().html(c)}),void 0):!1},"{likeButton} click":function(c){if(!b.options.registeredUser)return!1;var d=b.likeButton();d.addClass("btnUnlike"),d.attr("data-original-title",a.language("COM_EASYDISCUSS_UNLIKE_THIS_POST")),d.find("i").removeClass("icon-ed-love").addClass("icon-ed-remove"),b.likeStatus().html(a.language("COM_EASYDISCUSS_UNLIKE")),d.removeClass("btnLike"),b.likeItem(c)
},"{unlikeButton} click":function(){var d=b.unlikeButton();d.addClass("btnLike"),d.attr("data-original-title",a.language("COM_EASYDISCUSS_LIKE_THIS_POST")),d.find("i").removeClass("icon-ed-remove").addClass("icon-ed-love"),b.likeStatus().html(a.language("COM_EASYDISCUSS_LIKES")),d.removeClass("btnUnlike"),b.likeItem()},"{unlikeButton} mouseover":function(){},"{unlikeButton} mouseout":function(){}}})}),a(document).on("mouseover.discussLikes",".discussLikes",function(){var b=a(this);if(void 0==b.data("like")){var c="true"===b.attr("data-registered-user");
b.implement(EasyDiscuss.Controller.Likes,{registeredUser:c})}}),b.resolve()}),EasyDiscuss.module("location",function(a){var b=this;EasyDiscuss.require().library("ui/autocomplete").done(function(){EasyDiscuss.Controller("Location.Form",{defaultOptions:{language:"en",initialLocation:null,mapType:"ROADMAP",height:"250px",width:"100%","{locationInput}":".locationInput","{locationLatitude}":".locationLatitude","{locationLongitude}":".locationLongitude","{latitudeDisplay}":".latitudeDisplay","{longitudeDisplay}":".longitudeDisplay","{locationMap}":".locationMap","{autoDetectButton}":".autoDetectButton","{locationCoords}":".locationCoords","{removeLocationButton}":".removeLocationButton"}},function(b){return{init:function(){var c=a.uid("ext");
window[c]=function(){a.___GoogleMaps.resolve()},a.___GoogleMaps||(a.___GoogleMaps=a.Deferred(),EasyDiscuss.require().script({prefetch:!1},"https://maps.googleapis.com/maps/api/js?sensor=true&language="+b.options.language+"&callback="+c)),a.___GoogleMaps.done(function(){b._init()})},_init:function(){b.geocoder=new google.maps.Geocoder,b.hasGeolocation=void 0!==navigator.geolocation,b.hasGeolocation?b.autoDetectButton().show():b.autoDetectButton().remove(),b.locationInput().autocomplete({delay:300,minLength:0,source:b.retrieveSuggestions,select:function(a,c){b.locationInput().autocomplete("close"),b.setLocation(c.item.location)
...
google.maps.event.addListener(d,"tilesloaded",function(){f.open(d,e),b.busy(!1)}),google.maps.event.addListener(e,"dragend",function(){b.getLocationByCoords(this.getPosition().lat(),this.getPosition().lng(),function(a){var c=a[0].formatted_address;b.locationInput().val(c)}),b.locationLatitude().val(this.getPosition().lat()),b.locationLongitude().val(this.getPosition().lng()),b.latitudeDisplay().html(this.getPosition().lat()),b.longitudeDisplay().html(this.getPosition().lng()),b.locationCoords().addClass("showCoords")
...
},buildDataset:function(b){var c=a.map(b,function(a){return{label:a.formatted_address,value:a.formatted_address,location:a}});return c},retrieveSuggestions:function(a,c){b.busy(!0);var d=a.term,e=function(a){c(a),b.busy(!1)};""==d?e(b.userLocations||[]):b.getLocationByAddress(d,function(a){e(b.buildDataset(a))})},suggestUserLocations:function(){b.hasGeolocation&&b.userLocations&&(b.removeLocation(),b.locationInput().autocomplete("search","")),b.busy(!1)},"{locationInput} blur":function(){setTimeout(function(){var c=a.trim(b.locationInput().val());
""==c?b.removeLocation():b.locationResolved?c!=b.lastResolvedLocation.formatted_address&&b.setLocation(b.lastResolvedLocation):b.removeLocation()},250)},"{autoDetectButton} click":function(){b.busy(!0),b.hasGeolocation&&!b.userLocations?b.getUserLocations(b.suggestUserLocations):b.suggestUserLocations()},"{removeLocationButton} click":function(){b.removeLocation()}}}),EasyDiscuss.Controller("Location.Map",{defaultOptions:{animation:"drop",language:"en",useStaticMap:!1,disableMapsUI:!0,zoom:5,fitBounds:null,minZoom:null,maxZoom:null,center:null,locations:[],mapType:"ROADMAP",width:500,height:400,"{locationMap}":".locationMap","{removeLocation}":".removeLocation"}},function(b){return{init:function(){if(b.mapLoaded=!1,!a.___GoogleMaps){a.___GoogleMaps=a.Deferred();
var c=a.uid("ext");window[c]=function(){a.___GoogleMaps.resolve()},EasyDiscuss.require().script({prefetch:!1},"https://maps.googleapis.com/maps/api/js?sensor=true&language="+b.options.language+"&callback="+c)}a.___GoogleMaps.done(function(){b._init()})},_init:function(){if(1==b.options.useStaticMap){var c="&language="+String(b.options.language),d="&size="+String(b.options.width)+"x"+String(b.options.height),e="&zoom="+String(b.options.zoom),f="&center="+String(parseFloat(b.options.locations[0].latitude).toFixed(6))+","+String(parseFloat(b.options.locations[0].longitude).toFixed(6)),g="&maptype="+google.maps.MapTypeId[b.options.mapType],h="&markers=",i="https://maps.googleapis.com/maps/api/staticmap?sensor=false"+c+d;
if(1==b.options.locations.length)h+=String(parseFloat(b.options.locations[0].latitude).toFixed(6))+","+String(parseFloat(b.options.locations[0].longitude).toFixed(6)),i+=e+f+g+h;else{var j=new Array;a.each(b.options.locations,function(a,b){j.push(String(parseFloat(b.latitude).toFixed(6))+","+String(parseFloat(b.longitude).toFixed(6)))}),h+=j.join("|"),i+=h+g}b.locationMap().show().html('<img src="'+i+'" />'),b.busy(!1)}else null===b.options.fitBounds&&(b.options.fitBounds=1==b.options.locations.length?!1:!0),b.options.disableMapsUI=Boolean(b.options.disableMapsUI),b.locations=new Array,a.each(b.options.locations,function(a,c){"null"!=c.latitude&&"null"!=c.longitude&&b.locations.push(new google.maps.LatLng(c.latitude,c.longitude))
...
})})},"{removeLocation} click":function(){disjax.loadingDialog(),disjax.load("location","confirmRemoveLocation",b.element.data("id").toString())}}}),b.resolve()})}),EasyDiscuss.module("newpost",function(a){var b=this;EasyDiscuss.Controller("DiscussNewPost",{defaultOptions:{"{pollsCheckbox}":".pollsChkbox","{radioButton}":".radioBtn","{chkboxButton}":".chkboxBtn"}},function(b){return{init:function(){},"{pollsCheckbox} click":function(){b.show()},"{chkboxButton} click":function(a){var c=a.attr("id");b.vote(c)},show:function(){a("#discuss-polls").toggle(),a("#discuss-multiple-polls").toggle(),a("#discuss-multiple-polls-title").toggle()
},vote:function(a){EasyDiscuss.ajax("site.views.polls.vote",{args:[a]},{success:function(){}})}}}),b.resolve()}),EasyDiscuss.module("polls",function(){var b=this;EasyDiscuss.require().view("field.form.polls.answer").done(function(a){EasyDiscuss.Controller("Polls.Answers",{defaultOptions:{pollId:null,"{voteCount}":".voteCount","{votersAvatar}":".votersAvatar","{votePoll}":".votePoll","{unvotePoll}":".unvotePoll","{pollGraph}":".pollGraph"}},function(b){return{init:function(){b.options.pollId=b.element.data("id")
},"{voteCount} click":function(){disjax.load("polls","getvoters",b.options.pollId.toString())},"{votePoll} change":function(){EasyDiscuss.ajax("site.views.polls.vote",{id:b.options.pollId}).done(function(b){a(b).each(function(b,c){a(".pollAnswerItem-"+c.id).find(".pollPercentage").html(c.percentage),a(".pollAnswerItem-"+c.id).find(".pollGraph").css("width",c.percentage+"%"),a(".pollAnswerItem-"+c.id).find(".voteCount").html(c.votes),a(".pollAnswerItem-"+c.id).find(".votersList").html(c.voters)})})}}}),EasyDiscuss.Controller("Polls.Form",{defaultOptions:{"{pollAnswers}":".pollAnswers","{pollAnswersList}":".pollAnswersList","{insertPollAnswer}":".insertPollAnswer","{pollCheckbox}":".pollCheckbox","{pollForm}":".pollForm","{deletedPolls}":"#pollsremove",view:{answerItem:"field.form.polls.answer"}}},function(a){return{init:function(){a.pollAnswers().implement(EasyDiscuss.Controller.Polls.Form.Answer,{pollController:a}),0==a.pollAnswers().length&&a.insertNewPollAnswer()
},resetPollForm:function(){a.pollAnswers(":not(:first)").remove(),a.pollForm().hide(),a.pollCheckbox().prop("checked",!1)},insertNewPollAnswer:function(b){a.view.answerItem({showRemove:a.pollAnswers().length>0}).implement(EasyDiscuss.Controller.Polls.Form.Answer,{pollController:a,shiftFocus:b}).appendTo(a.pollAnswersList())},updateDeletedPoll:function(b){var c=a.deletedPolls().val();""!=c&&(c+=","),a.deletedPolls().val(c+b)},showPollForm:function(){a.pollForm().show()},"{insertPollAnswer} click":function(){a.insertNewPollAnswer(!0)
...
var f=function(f){var g,h=f.selector||"";h?(g=b.find(this,c,h),g.length||a(this).delegate(h,d,e)):b.find(this,c,h).length||b.add(this,d,e,{selector:h,delegate:this})},g=function(f){var g,h=f.selector||"";h?(g=b.find(this,c,h),g.length||a(this).undelegate(h,d,e)):b.find(this,c,h).length||b.remove(this,d,e,{selector:h,delegate:this})};a.each(c,function(){b.special[this]={add:f,remove:g,setup:function(){},teardown:function(){}}})};var d="ontouchend"in document,f=d?"touchstart":"mousedown",g=d?"touchend":"mouseup",i=function(b){var c=b.originalEvent.touches?b.originalEvent.touches[0]||b.originalEvent.changedTouches[0]:b;
return{time:(new Date).getTime(),coords:[c.pageX,c.pageY],origin:a(b.target)}};a.event.setupHelper(["tap"],f,function(b){function m(g){d=i(g),(Math.abs(c.coords[0]-d.coords[0])<10||Math.abs(c.coords[1]-d.coords[1])<10)&&a.each(a.event.find(e,["tap"],f),function(){this.call(h,b,{start:c,end:d})})}var d,l,c=i(b),e=b.delegateTarget||b.currentTarget,f=b.handleObj.selector,h=this;l=setTimeout(function(){a(e).unbind(g,m)},500),a(e).one(g,m)})}();var b=this;EasyDiscuss.require().done(function(a){EasyDiscuss.Controller("Toolbar",{defaultOptions:{"{items}":".toolbarItem","{dropdowns}":".dropdown-menu","{notificationLink}":".notificationLink","{notificationDropDown}":".notificationDropDown","{notificationResult}":".notificationResult","{notificationItems}":".notificationItem","{notificationLoader}":".notificationLoader","{messageLink}":".messageLink","{messageDropDown}":".messageDropDown","{messageResult}":".messageResult","{messageLoader}":".messageLoader","{messageItems}":".messageItem","{logoutForm}":"#logoutForm","{logoutButton}":".logoutButton","{loginLink}":".loginLink","{loginDropDown}":".loginDropDown","{profileLink}":".profileLink","{profileDropDown}":".profileDropDown"}},function(b){return{init:function(){a.responsive(b.element,{elementWidth:function(){return b.element.outerWidth(!0)-15
},conditions:{at:function(){var c=0;return b.items().each(function(b,d){c+=a(d).outerWidth(!0)}),c}(),alsoSwitch:{".dc_toolbar-wrapper":"narrow",".dc-button":"show","#dc_toolbar":"hidden-height"}}})},"{logoutButton} click":function(){b.logoutForm().submit()},"{loginLink} click":function(){b.messageDropDown().hide(),b.notificationDropDown().hide(),b.loginDropDown().toggle()},"{profileLink} tap":function(){b.messageDropDown().hide(),b.notificationDropDown().hide(),b.profileDropDown().toggle()},"{messageLink} tap":function(){if(b.profileDropDown().hide(),b.notificationDropDown().hide(),"none"==b.messageDropDown().css("display")){var c={};
c[a(".easydiscuss-token").val()]=1,EasyDiscuss.ajax("site.views.conversation.load",c,{beforeSend:function(){b.messageLoader().show(),b.messageItems().remove()},success:function(a){b.messageLoader().hide(),b.messageResult().append(a)}})}b.messageDropDown().toggle()},"{notificationLink} tap":function(){if(b.messageDropDown().hide(),b.profileDropDown().hide(),"none"==b.notificationDropDown().css("display")){var c={};c[a(".easydiscuss-token").val()]=1,EasyDiscuss.ajax("site.views.notifications.load",c,{beforeSend:function(){b.notificationLoader().show(),b.notificationItems().remove()
},success:function(a){b.notificationLoader().hide(),b.notificationResult().append(a)}})}b.notificationDropDown().toggle()}}}),EasyDiscuss.Controller("mod_notifications",{defaultOptions:{"{items}":".toolbarItem","{dropdowns}":".dropdown-menu","{notificationLink}":".notificationLink","{notificationDropDown}":".notificationDropDown","{notificationResult}":".notificationResult","{notificationItems}":".notificationItem","{notificationLoader}":".notificationLoader","{messageLink}":".messageLink","{messageDropDown}":".messageDropDown","{messageResult}":".messageResult","{messageLoader}":".messageLoader","{messageItems}":".messageItem","{logoutForm}":"#logoutForm","{logoutButton}":".logoutButton","{loginLink}":".loginLink","{loginDropDown}":".loginDropDown","{profileLink}":".profileLink","{profileDropDown}":".profileDropDown"}},function(b){return{init:function(){a.responsive(b.element,{elementWidth:function(){return b.element.outerWidth(!0)-15
},conditions:{at:function(){var c=0;return b.items().each(function(b,d){c+=a(d).outerWidth(!0)}),c}(),alsoSwitch:{".dc_toolbar-wrapper":"narrow",".dc-button":"show","#dc_toolbar":"hidden-height"}}})},"{logoutButton} click":function(){b.logoutForm().submit()},"{loginLink} click":function(){b.messageDropDown().hide(),b.notificationDropDown().hide(),b.loginDropDown().toggle()},"{profileLink} click":function(){b.messageDropDown().hide(),b.notificationDropDown().hide(),b.profileDropDown().toggle()},"{messageLink} click":function(){if(b.profileDropDown().hide(),b.notificationDropDown().hide(),"none"==b.messageDropDown().css("display")){var c={};
c[a(".easydiscuss-token").val()]=1,EasyDiscuss.ajax("site.views.conversation.load",c,{beforeSend:function(){b.messageLoader().show(),b.messageItems().remove()},success:function(a){b.messageLoader().hide(),b.messageResult().append(a)}})}b.messageDropDown().toggle()},"{notificationLink} click":function(){if(b.messageDropDown().hide(),b.profileDropDown().hide(),"none"==b.notificationDropDown().css("display")){var c={};c[a(".easydiscuss-token").val()]=1,EasyDiscuss.ajax("site.views.notifications.load",c,{beforeSend:function(){b.notificationLoader().show(),b.notificationItems().remove()
},success:function(a){b.notificationLoader().hide(),b.notificationResult().append(a)}})}b.notificationDropDown().toggle()}}}),b.resolve()})})});